...
function removeIngrediente(event) {
  ...
  itensPedido[indice].ingredientes = [
    ...itensPedido[indice].ingredientes.filter(ing => ing.id !== idIngrediente)
  ];
...
function handleConfirm(event) {
  ...
  console.log('oi', JSON.stringify(itensPedido, null, 2));
}
